...
class RegistrationForm(FlaskForm):
    ...
    mobile = IntegerField('Mobile', validators=[DataRequired()], render_kw={"placeholder": "05xxxxxxxx"})
    gender = SelectField('Gender',
                          choices=[('NA','Select your gender'),('Male', 'Male'), ('Female', 'Female')])    
    city = SelectField('City',
                          choices=[('NA','Select your city'),('Jeddah', 'Jeddah'), ('Riyadh', 'Riyadh'), ('Dammam', 'Dammam')], render_kw={"placeholder": "Choose"})    
