...
class RegistrationForm(FlaskForm):
    ...
    gender = SelectField('',
                         choices=[('NA', 'Gender'), ('Male', 'Male'), ('Female', 'Female')],
                         validators=[AnyOf(values=['Male', 'Female'], message='Select a Gender')])
    role = SelectField('',
                       choices=[('NA', 'Role'), ('trainee', 'Trainee'), ('trainer', 'Trainer')],
                       validators=[AnyOf(values=['trainee', 'trainer'], message='Select a Role')])
    city = SelectField('',
                       choices=[('NA', 'City'), ('Jeddah', 'Jeddah'), ('Riyadh', 'Riyadh'), ('Dammam', 'Dammam')],
                       validators=[AnyOf(values=['Jeddah', 'Riyadh', 'Dammam'], message='Select a City')])
...
class UpdateUserForm(FlaskForm):
    ...
    gender = SelectField('',
                         choices=[('NA', 'Gender'), ('Male', 'Male'), ('Female', 'Female')],
                         validators=[AnyOf(values=['Male', 'Female'], message='Choose your gender!')])
    city = SelectField('',
                       choices=[('NA', 'City'), ('Jeddah', 'Jeddah'), ('Riyadh', 'Riyadh'), ('Dammam', 'Dammam')],
                       validators=[AnyOf(values=['Jeddah', 'Riyadh', 'Dammam'], message='Choose your city!')])
    birthdate = DateField('Date of Birth', format='%Y-%m-%d', validators=[DataRequired()])
