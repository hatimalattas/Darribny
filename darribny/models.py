...
class Trainee(db.Model,UserMixin):
    ...
    reservations = db.relationship('Reservation',backref='trainees',lazy=True)

    def __init__(self,email,username,password,birthday, first_name, last_name, gender, city, mobile):
        self.email = email
